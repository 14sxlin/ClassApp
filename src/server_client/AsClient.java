 ...
 *
 */
public interface AsClient extends MySocketClient,MySocketServer {
	/**
	 ...
	 */
	abstract String sendDestinationHeader(MySocketClient client);
	/**
	 * @return 获取自己的信息,包括IP地址,服务端端口号等
	 */
	abstract String getMyIp();
